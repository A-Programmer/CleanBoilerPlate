...
namespace Project.Webframeworks
{
    public class ApiResult
    {
        ...
        public ApiResult(bool isSucceeded, HttpStatusCode statusCode, List<string> errors, string message = null)
        {
        ...
        where TData : class
    {
        ...
        public ApiResult(bool isSucceeded, HttpStatusCode statusCode, TData data, List<string> errors, string message = null)
